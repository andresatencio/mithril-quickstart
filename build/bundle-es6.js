...
(function e(t, n, r) {
	function s(o, u) {
		...
		var Navbar = module.exports = {
			controller: function () {
				...
				var links = (Auth.token() ? [{ label: "Tasty", href: "/tasty" }, { label: "Logout", href: "/logout" }] : [{ label: "Login", href: "/login" }, { label: "Register", href: "/register" }]).map(function (l) {
			...
			view: function (ctrl) {
				return m("nav.navbar.navbar-inverse.navbar-fixed-top", [m(".container", [m(".navbar-header", m("button.navbar-toggle", { onclick: ctrl.toggle }, m(".glyphicon.glyphicon-chevron-" + ctrl.iconDirection())), m("a.navbar-brand[href='/']", { config: m.route }, "Tu app")), m(".navbar-collapse." + ctrl.iconDirection(), m("ul.nav.navbar-nav.navbar-right", ctrl.links()))])]);
			}
		};
	}, { "../models/Auth.js": 3, mithril: 11 }], 2: [function (require, module, exports) {
		var m = require("mithril");
		...
		m.route(document.body, "/", {
			...
			"/prueba": require("./pages/Prueba.js")
		});
	}, { "./pages/Home.js": 4, "./pages/Login.js": 5, "./pages/Logout.js": 6, "./pages/Prueba.js": 7, "./pages/Register.js": 8, "./pages/Tasty.js": 9, "./pages/Verify.js": 10, mithril: 11 }], 3: [function (require, module, exports) {
		var m = require("mithril");
	...
	}, { mithril: 11 }], 4: [function (require, module, exports) {
		var m = require("mithril");
		...
		var Home = module.exports = {
			controller: function () {
				...
				ctrl.message = m.prop();
				if (!Auth.token()) {
					ctrl.message(["Ok! Things seem cool, so go check out the files in ", m("code", "public/"), " to see how it's all put together. Your're going to have to ", m("a[href=\"/register\"]", { config: m.route }, "make"), " a ", m("code", "User"), " to be able to ", m("a[href='/login']", { config: m.route }, "login"), "."]);
				} else {
					ctrl.message(["You are logged in, so go check out ", m("a[href=\"/tasty\"]", { config: m.route }, "tasty"), "."]);
				}
			},

			view: function (ctrl) {
				return [Navbar.view(ctrl.navbar), m(".container", [m("h1", "home"), m("p", ctrl.message()), m("p", "You can edit this file in ", [m("code", "public/js/pages/Home.js"), "."]), m("p", "Lorem ipsum Cupidatat sed labore reprehenderit aliqua id culpa irure in incididunt voluptate sed quis irure amet proident in adipisicing ea enim dolore Duis aliqua dolor dolore pariatur tempor aliquip velit officia laborum ullamco adipisicing consectetur Ut incididunt in labore do aute eu ea consectetur elit quis magna non laborum velit reprehenderit in cillum cillum laborum deserunt velit officia dolor nulla consectetur ex consectetur elit ad consectetur dolor cillum laboris enim quis voluptate id eu voluptate esse deserunt dolor Duis velit aliqua ex non eiusmod culpa proident incididunt ea irure in quis sint quis Excepteur velit et sunt nisi aute sint laborum Ut sit veniam cupidatat elit consequat nostrud aliqua quis in dolor ex ut adipisicing deserunt irure dolore minim enim ullamco consequat commodo sunt elit est cupidatat sint laboris mollit nulla eu est Excepteur pariatur velit magna eiusmod laborum tempor tempor id eiusmod sit proident quis cillum anim eiusmod occaecat sed adipisicing dolore est anim cillum voluptate."), m("p", "Lorem ipsum Cupidatat sed labore reprehenderit aliqua id culpa irure in incididunt voluptate sed quis irure amet proident in adipisicing ea enim dolore Duis aliqua dolor dolore pariatur tempor aliquip velit officia laborum ullamco adipisicing consectetur Ut incididunt in labore do aute eu ea consectetur elit quis magna non laborum velit reprehenderit in cillum cillum laborum deserunt velit officia dolor nulla consectetur ex consectetur elit ad consectetur dolor cillum laboris enim quis voluptate id eu voluptate esse deserunt dolor Duis velit aliqua ex non eiusmod culpa proident incididunt ea irure in quis sint quis Excepteur velit et sunt nisi aute sint laborum Ut sit veniam cupidatat elit consequat nostrud aliqua quis in dolor ex ut adipisicing deserunt irure dolore minim enim ullamco consequat commodo sunt elit est cupidatat sint laboris mollit nulla eu est Excepteur pariatur velit magna eiusmod laborum tempor tempor id eiusmod sit proident quis cillum anim eiusmod occaecat sed adipisicing dolore est anim cillum voluptate."), m("p", "Lorem ipsum Cupidatat sed labore reprehenderit aliqua id culpa irure in incididunt voluptate sed quis irure amet proident in adipisicing ea enim dolore Duis aliqua dolor dolore pariatur tempor aliquip velit officia laborum ullamco adipisicing consectetur Ut incididunt in labore do aute eu ea consectetur elit quis magna non laborum velit reprehenderit in cillum cillum laborum deserunt velit officia dolor nulla consectetur ex consectetur elit ad consectetur dolor cillum laboris enim quis voluptate id eu voluptate esse deserunt dolor Duis velit aliqua ex non eiusmod culpa proident incididunt ea irure in quis sint quis Excepteur velit et sunt nisi aute sint laborum Ut sit veniam cupidatat elit consequat nostrud aliqua quis in dolor ex ut adipisicing deserunt irure dolore minim enim ullamco consequat commodo sunt elit est cupidatat sint laboris mollit nulla eu est Excepteur pariatur velit magna eiusmod laborum tempor tempor id eiusmod sit proident quis cillum anim eiusmod occaecat sed adipisicing dolore est anim cillum voluptate."), m("p", "Lorem ipsum Cupidatat sed labore reprehenderit aliqua id culpa irure in incididunt voluptate sed quis irure amet proident in adipisicing ea enim dolore Duis aliqua dolor dolore pariatur tempor aliquip velit officia laborum ullamco adipisicing consectetur Ut incididunt in labore do aute eu ea consectetur elit quis magna non laborum velit reprehenderit in cillum cillum laborum deserunt velit officia dolor nulla consectetur ex consectetur elit ad consectetur dolor cillum laboris enim quis voluptate id eu voluptate esse deserunt dolor Duis velit aliqua ex non eiusmod culpa proident incididunt ea irure in quis sint quis Excepteur velit et sunt nisi aute sint laborum Ut sit veniam cupidatat elit consequat nostrud aliqua quis in dolor ex ut adipisicing deserunt irure dolore minim enim ullamco consequat commodo sunt elit est cupidatat sint laboris mollit nulla eu est Excepteur pariatur velit magna eiusmod laborum tempor tempor id eiusmod sit proident quis cillum anim eiusmod occaecat sed adipisicing dolore est anim cillum voluptate.")])];
			}
		};
	}, { "../components/Navbar.js": 1, "../models/Auth.js": 3, mithril: 11 }], 5: [function (require, module, exports) {
		var m = require("mithril");
		...
		var Login = module.exports = {
			controller: function () {
				...
				this.login = function (e) {
					e.preventDefault();
					Auth.login(e.target.email.value, e.target.password.value).then(function () {
			...
			view: function (ctrl) {
				return [Navbar.view(ctrl.navbar), m(".container", [m("form.text-center.row.form-signin", { onsubmit: ctrl.login.bind(ctrl) }, m(".col-sm-6.col-sm-offset-3", [m("h1", "login"), ctrl.error(), m(".form-group", [m("label.sr-only[for='inputEmail']", "Email address"), m("input.form-control[name='email'][autofocus][id='inputEmail'][placeholder='Email address'][required][type='email']")]), m(".form-group", [m("label.sr-only[for='inputPassword']", "Password"), m("input.form-control[name='password'][autocomplete='off'][id='inputPassword'][placeholder='Password'][required][type='password']")]), m(".form-group", m("button.btn.btn-lg.btn-primary.btn-block[type='submit']", "Sign in"))]))])];
			}
		};
	}, { "../components/Navbar.js": 1, "../models/Auth.js": 3, mithril: 11 }], 6: [function (require, module, exports) {
		var m = require("mithril");
	...
	}, { "../models/Auth.js": 3, mithril: 11 }], 7: [function (require, module, exports) {
		var m = require("mithril");
		var Navbar = require("../components/Navbar.js");
		...
		var Prueba = module.exports = {
			...
			view: function (ctrl) {
				return { tag: "div", attrs: {}, children: [Navbar.view(ctrl.navbar), { tag: "div", attrs: { "class": "container" }, children: [{ tag: "h1", attrs: {}, children: ["Ahora si"] }, { tag: "h2", attrs: {}, children: ["Somos nosotros!"] }, { tag: "h3", attrs: {}, children: ["Contador:"] }, { tag: "p", attrs: {}, children: [ctrl.contador] }, { tag: "p", attrs: {}, children: [ctrl.saluda] }, { tag: "form", attrs: {}, children: [{ tag: "label", attrs: { "for": "nombre" }, children: ["Nombre"] }, { tag: "input", attrs: { type: "text", onchange: m.withAttr("value", ctrl.nombre), value: ctrl.nombre(), placeholders: "Escribi tu nombre" } }, { tag: "button", attrs: { onclick: ctrl.enviar.bind(ctrl) }, children: ["Enviar"] }, { tag: "span", attrs: {}, children: [ctrl.nombre()] }] }] }] };

			}
		};
	}, { "../components/Navbar.js": 1, mithril: 11 }], 8: [function (require, module, exports) {
		var m = require("mithril");
		...
		var Register = module.exports = {
			controller: function () {
				...
				ctrl.register = function (e) {
					...
					Auth.register(e.target.email.value, e.target.password.value).then(function () {
			...
			view: function (ctrl) {
				return [Navbar.view(ctrl.navbar), m(".container", [m("form.text-center.row.form-signin", { onsubmit: ctrl.register.bind(ctrl) }, m(".col-sm-6.col-sm-offset-3", [m("h1", "register"), ctrl.error(), m(".form-group", [m("label.sr-only[for='inputEmail']", "Email address"), m("input.form-control[name='email'][autofocus][id='inputEmail'][placeholder='Email address'][required][type='email']")]), m(".form-group", [m("label.sr-only[for='inputPassword']", "Password"), m("input.form-control[name='password'][autocomplete='off'][id='inputPassword'][placeholder='Password'][required][type='password']")]), m(".form-group", [m("label.sr-only[for='inputPassword2']", "Password (again)"), m("input.form-control[name='password2'][autocomplete='off'][id='inputPassword2'][placeholder='Password (again)'][required][type='password']")]), m(".form-group", m("button.btn.btn-lg.btn-primary.btn-block[type='submit']", "Sign in"))]))])];
			}
		};
	}, { "../components/Navbar.js": 1, "../models/Auth.js": 3, mithril: 11 }], 9: [function (require, module, exports) {
		var m = require("mithril");
		...
		var Tasty = module.exports = {
			...
			view: function (ctrl) {
				return [Navbar.view(ctrl.navbar), m(".container", [m("h1", "tasty"), m("p", "this is a demo of locking things down on client & server. This is you:"), ctrl.user()])];
			}
		};
	}, { "../components/Navbar.js": 1, "../models/Auth.js": 3, mithril: 11 }], 10: [function (require, module, exports) {
		var m = require("mithril");
		...
		var Verify = module.exports = {
			...
			view: function (ctrl) {
				return [Navbar.view(ctrl.navbar), m(".container", [m("h1", "verify"), ctrl.message()])];
			}
		};
	}, { "../components/Navbar.js": 1, "../models/Auth.js": 3, mithril: 11 }], 11: [function (require, module, exports) {
			...
			function build(parentElement, parentTag, parentCache, parentIndex, data, cached, shouldReattach, index, editable, namespace, configs) {
				...
				if (dataType === ARRAY) {
					...
					if (shouldMaintainIdentities) {
						if (data.indexOf(null) > -1) data = data.filter(function (x) {
							return x != null;
						});
